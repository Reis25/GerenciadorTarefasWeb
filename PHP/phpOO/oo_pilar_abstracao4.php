...
//Chamando métodos internos
	...
	class Funcionario{	
		...
		function resumirCadFunc (){
			...
			return $this->__get('nome')." possui ".$this->__get('numFilhos')." filhos(a) e seu telefone é".$this->__get('telefone').", seu cargo ".$this->__get('cargo')." e seu salário ".$this->__get('salario');
		}
